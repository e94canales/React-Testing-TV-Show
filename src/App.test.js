...
test('Render data after API is called & Can select seasons', async () => {
    // LOADS DATA
    ...
    expect(getByText(/Chapter One: Suzie, Do You Copy/i)).toBeInTheDocument()

    // CAN CHANGE SEASON
    userEvent.click(getAllByText(/season 3/i)[0])
    userEvent.click(getByText(/season 4/i))
    expect(getByText(/Chapter One: The Hellfire Club/i)).toBeInTheDocument()

    // CALLED FOR DATA ONCE
